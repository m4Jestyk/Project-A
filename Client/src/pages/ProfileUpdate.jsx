                    ...
                    <VStack spacing={5}>
                      ...
                      <FormControl>
                        ...
                        <Input
                          type="password"
                          name="password"
                          placeholder="I wont tell anyone, promise ;)"
                        />
                      </FormControl>

                      <FormControl isRequired>
                        <FormLabel>Your Short Bio</FormLabel>

                        <Textarea
                          name="shortBio"
                          placeholder="Write something about you in short and creative way so that people like your profile based on it"
                          rows={6}
                          value={user.shortBio || ""}
                          onChange={(e) => {
                            setUser({
                      ...
                      <FormControl isRequired>
                        <FormLabel>Your Full Bio</FormLabel>

                        <Textarea
                          name="fullBio"
                          placeholder="Write everything about you, you want someone to know..."
                          rows={6}
                          value={user.fullBio || ""}
                          onChange={(e) => {
                            setUser({
                      ...
                      <FormControl isRequired>
                        <FormLabel>Your Top 4 interests</FormLabel>
                          ...
                          <Flex direction={"column"} align={"center"}>
                            <Flex>
                              ...
                              <Input
                                m={2}
                                value={
                                  user.interests && user.interests[1]
                                    ? user.interests[1]
                                    : ""
                                }
                                onChange={(e) => {
                            ...
                            <Flex>
                              <Input
                                m={2}
                                value={
                                  user.interests && user.interests[2]
                                    ? user.interests[2]
                                    : ""
                                }
                                onChange={(e) => {
                              ...
                              <Input
                                m={2}
                                value={
                                  user.interests && user.interests[3]
                                    ? user.interests[3]
                                    : ""
                                }
                                onChange={(e) => {
